...
def get_localized_string(text, lang="English"):
    translations = {
        ...
        "module_impact_analysis_query": {
            "English": "How did this module shape the conversation? (1-2 sentences, plain text, NO markdown)\n\n",
        },
